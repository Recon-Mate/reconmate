      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav m-auto mb-2 mb-lg-0 ps-4">
          ...
          <li class="nav-item">
            <a
              :to="`#${aboutId}`"
              @click.prevent="scrollToTarget(aboutId)"
              class="nav-link"
            >
              About
            </a>
          ...
          <li class="nav-item">
            <a
              :to="`#${faqId}`"
              @click.prevent="scrollToTarget(faqId)"
              class="nav-link"
            >
              FAQ
            </a>
          ...
          <li class="nav-item">
            <a
              :to="`#${teamId}`"
              @click.prevent="scrollToTarget(teamId)"
              class="nav-link"
            >
              Team
            </a>
        ...
        <div class="nav-side">
          <div class="d-flex align-items-center">
            <!-- <NuxtLink to="/writeups" class="side_menu_btn">
            ...
            >
              <span>Find Writeups <i class="bi bi-arrow-right ms-1"></i> </span>
            </NuxtLink>
          </div>
        </div>
      </div>
